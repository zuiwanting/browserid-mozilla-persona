...
exports.setup = function(app) {
  ...
  if ([ 'https://persona.org', 'https://anosrep.org' ].indexOf(config.get('public_url')) === -1) {
  ...
  // persona.org is a (uh, THE) secondary, it should publish its key
  ...
  // persona.org as a secondary (and anyone else they decide to for
  // whatever reason).
